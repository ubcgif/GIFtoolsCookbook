...
.. note:: If you do not have XYZ formatted data from which to work with, you may `download tutorial data <https://github.com/ubcgif/GIFtoolsCookbook/raw/master/main/comprehensive_tutorial_mmt.zip>`_ . It is from this dataset that we will demonstrate the workflow.
